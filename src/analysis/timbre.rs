...
pub const RECORDED: &[Fingerprint] = &[
    Fingerprint {
        ...
        resonances: &[1483.3, 216.4, 3598.1],
    ...
    Fingerprint {
        ...
        resonances: &[1535.9, 3900.6, 84.3],
        tilt_db_per_octave: -10.5,
    },
    Fingerprint {
    ...
    Fingerprint {
        ...
        resonances: &[1553.2, 1194.8, 274.9],
    ...
    Fingerprint {
        ...
        resonances: &[104.4, 1787.0, 1111.9],
    ...
    Fingerprint {
        ...
        resonances: &[148.7, 1407.6, 1025.0],
    ...
    Fingerprint {
        ...
        resonances: &[408.9, 2036.6, 3592.5],
        tilt_db_per_octave: -5.0,
    },
    Fingerprint {
        preset: "Big Single",
        firing_order: 0.5,
        balance: &[(0.5, 0.0), (1.0, 10.3)],
        resonances: &[115.6, 2096.1, 1197.4],
