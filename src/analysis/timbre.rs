...
pub const RECORDED: &[Fingerprint] = &[
    Fingerprint {
        ...
        resonances: &[1483.1, 216.3, 3598.7],
    ...
    Fingerprint {
        ...
        resonances: &[1983.4, 3360.3, 2400.5],
    ...
    Fingerprint {
        ...
        resonances: &[148.6, 2827.2, 1024.9],
    ...
    Fingerprint {
        ...
        resonances: &[409.3, 1559.4, 2037.7],
        tilt_db_per_octave: -5.1,
    },
    Fingerprint {
        preset: "Big Single",
        firing_order: 0.5,
        balance: &[(0.5, 0.0), (1.0, 9.5)],
        resonances: &[115.9, 1197.6, 2096.2],
